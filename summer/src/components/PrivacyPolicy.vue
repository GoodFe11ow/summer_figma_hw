<template>
  <div>
    ...
    <div class="bg-white pt-30 pb-20 xl:pr-[140px] md:pr-[80px] sm:pr-[32px] pr-[20px] xl:pl-[150px] md:pl-[80px] sm:pl-[32px] pl-[20px]">
      <div class="flex flex-col gap-[40px]">
        ...
        <div>
          <div class="flex flex-col">
            <div class="pt-[4px] pb-[4px] pl-[4px]">
              <img src="https://picsum.photos/1200/600" alt="Random image" class="w-full h-auto" />
            </div>

            <div class="py-[20px]">
              <div class="flex flex-col gap-[60px]">
                <div>
                  <p class="font-[outfit] font-normal text-[#33B8A9] text-[20px]">
                    Last revised on April 21st, 2021.
                  </p>
                </div>

                <p class="font-[outfit] font-normal text-[#004B49] text-[18px]">
                  This page is used to inform website visitors regarding our
                  policies with the collection, use, and disclosure of Personal
                  Information if anyone decided to use our website. If you
                  choose to visit our website, then you agree to the collection
                  and use of information in relation with this policy. The
                  Personal Information that we collect are used for providing
                  and improving the website. We will not use or share your
                  information with anyone except as described in this Privacy
                  Policy.
                </p>

                <div class="flex flex-col gap-[20px]">
                  <h3 class="font-[outfit] font-semibold text-[#004B49] text-[28px]">
                    Information collection and use
                  </h3>
                  <p class="font-[outfit] font-normal text-[#004B49] text-[18px]">
                    For a better experience while using our website, we may
                ...
                <div class="flex flex-col gap-[20px]">
                  ...
                  <p class="font-[outfit] font-normal text-[#004B49] text-[18px]">
                    ...
                    version, pages of our website that you visit, the time and
                ...
                <div class="flex flex-col gap-[20px]">
                  ...
                  <p class="font-[outfit] font-normal text-[#004B49] text-[18px]">
                    ...
                    used as an anonymous unique identifier. These are sent to
                    your browser from the website that you visit and are stored
                    on your computer’s hard drive.
                  </p>
                  <p class="font-[outfit] font-normal text-[#004B49] text-[18px]">
                    Our website uses these “cookies” to collect information and
                    to improve our website. You have the option to either accept
                ...
                <div class="flex flex-col gap-[20px]">
                  ...
                  <ul class="list-disc font-[outfit] font-normal text-[#004B49] text-[18px] pl-[20px]">
