<template>
  <div>
    ...
    <div class="bg-white pt-30 pb-20 xl:pr-[140px] md:pr-20 sm:pr-8 pr-5 xl:pl-[150px] md:pl-24 sm:pl-9 pl-6">
        ...
        <div class="flex flex-col lg:flex-row gap-10">
          ...
          <form @submit.prevent="submitForm" class="flex flex-col sm:gap-15 gap-[40px] w-full">
            <div class="flex flex-col gap-3">
              <p class="block text-4 font-[outfit] font-normal text-[#818EB0]">Full Name</p>
            ...
            <div class="flex flex-col gap-3">
              <p class="block text-4 font-[outfit] font-normal text-[#818EB0]">Email Address</p>
              <input v-model="form.email" name="email" autocomplete="email"
                class="w-full h-16 border border-[#00A693] bg-[#E5F6F4] text-[#030024] p-5 rounded-sm focus:outline-none focus:ring-1 focus:ring-[#1a7369] focus:bg-white" />
            </div>

            <div class="flex flex-col gap-3">
              <p class="block text-4 font-[outfit] font-normal text-[#818EB0]">Company Name</p>
              <input v-model="form.companyName" name="companyName"
                class="w-full h-16 border border-[#00A693] bg-[#E5F6F4] text-[#030024] p-5 rounded-sm focus:outline-none focus:ring-1 focus:ring-[#1a7369] focus:bg-white" />
            </div>

            <div class="flex flex-col gap-3">
              <p class="block text-4 font-[outfit] font-normal text-[#818EB0]">Project Budget (USD)</p>
              <input v-model="form.budget" name="budget"
                class="w-full h-16 border border-[#00A693] bg-[#E5F6F4] text-[#030024] p-5 rounded-sm focus:outline-none focus:ring-1 focus:ring-[#1a7369] focus:bg-white" />
            </div>

            <div class="flex flex-col gap-3">
              <p class="block text-4 font-[outfit] font-normal text-[#818EB0]">Please tell us a bit about your project</p>
          ...
          <div class="flex flex-col gap-[40px] w-full text-right">
            <div class="flex flex-col gap-3">
              <p class="font-[outfit] font-normal text-[#008576] sm:text-[20px] text-[18px]">Or write us an email directly</p>
            ...
            <div class="flex flex-col gap-10">
              <div class="flex flex-col gap-3">
                ...
                <p class="font-[outfit] font-normal text-[#008576] sm:text-[20px] text-[18px]">
                  +880 130 3478 950 <br>+880 177 5963 777
                </p>
              </div>
              <div class="flex flex-col gap-3">
                <h3 class="font-[outfit] font-semibold text-[#008576] sm:text-[28px] text-[24px]">Address</h3>
                <p class="font-[outfit] font-normal text-[#008576] sm:text-[20px] text-[18px]">
                  2352 Middlefield Rd, Markham <br>Ontario, Canada
                </p>
              </div>
